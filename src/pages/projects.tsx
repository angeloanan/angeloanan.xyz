    ...
    <>
      ...
      <Box mb={4} as='article'>
        ...
        <Box as='section' mt={8}>
          ...
          <TextParagraph>
            Frontend Indonesia is community of Indonesians Front-End developer.
            Imagine &quot;
            <Text as='em'>
          ...
          <TextParagraph mt={2}>
            ...
            &quot;melting pot&quot; of many Indonesian Front-end community. We
            are targeting so that everyone have a space to talk about anything,
            from beginners to seniors, from developer to recruiter, from legacy
            to modern.
          </TextParagraph>
        ...
        <Box as='section' mt={8}>
          ...
          <TextParagraph mt={2}>
            As the country started lockdown because of COVID-19, I&apos;ve
            joined the KawalCOVID19 team to help manage and publish their
            content. In addition, I did some help on pushing new features on
            their website.
          </TextParagraph>
        </Box>
        ...
        <Box as='section' mt={8}>
          ...
          <TextParagraph mt={2}>
            ...
            &mdash; searches the lyrics to your currently playing Spotify music.
            It works by using the Genius API and scraping it manually as there
            are some caveats on their API (they don&apos;t give out lyrics).
          </TextParagraph>
        </Box>
      </Box>
    </>
